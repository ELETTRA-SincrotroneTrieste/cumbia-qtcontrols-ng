...
public:
    ...
    virtual QString group() const { return "cumbia-qtcontrols-ng-controls"; }
...
class QuNumericControlW_Interface : public CuCustomWidgetInterface
{
   Q_OBJECT
    Q_INTERFACES(QDesignerCustomWidgetInterface)

  public:
    QuNumericControlW_Interface(QObject* parent, CumbiaPool *cumbia_p, const CuControlsFactoryPool &ctrl_factory_p);
